...
def parse_cl_args():
    ...
    parser.add_argument("-func", type=str, default='booth', dest='func',
    ...
    parser.add_argument("-mode", default="original", dest='mode',
                        help="choose between 'original' and 'optimised' algorithm, default: original")
...
def main():
    ...
    if args.func in test_functions:
        func = test_functions[args.func]
    else:
        print(
            'Missing supplied function ' + args.func + ' definition. Ensure function defintion exists or use command line options.')
        return

    if args.c is None:
        if args.func in function_constraints:
            args.c = function_constraints[args.func]
        else:
            print(
                'Missing constraints for supplied function ' + args.func + '. Define constraints before use or supply via command line.')
            return
